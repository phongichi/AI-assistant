...
def greet(status):
	...
	msg = " the Virtual Assistant here. There's a lot I can help with. " + m

	if previous_date == today_date:
		output("Welcome back " + msg)
	else:
		hour = int(get_hours())
		if (hour >= 4 and hour <12 ):
			output("Good Morning, " +msg)
		elif (hour >= 12 and hour <16 ):
			output("Good Afternoon, " +msg)
		else:
			output("Good Evening, " +msg)
